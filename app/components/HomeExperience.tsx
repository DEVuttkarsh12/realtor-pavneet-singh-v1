    ...
    <SiteChrome darkHeader>
      <main>
        <section className="home-hero" aria-labelledby="hero-title">
          ...
          <div className="hero-data shell hero-enter delay-4">
            <div><AnimatedNumber end={100} suffix="+" /><span>Units represented</span></div>
            <div><strong>All NS</strong><span>Province-wide guidance</span></div>
            <div><AnimatedNumber end={6} /><span>Languages spoken</span></div>
            <a href="#introduction">Scroll to discover <span>↓</span></a>
          </div>
        </section>
        ...
        <div className="motion-ribbon" aria-hidden="true">
          <div>
            <span>Residential</span><i>✦</i><span>Investment</span><i>✦</i>
            <span>Commercial</span><i>✦</i><span>Land &amp; development</span><i>✦</i>
            <span>Relocation</span><i>✦</i><span>Nova Scotia</span><i>✦</i>
            <span>Residential</span><i>✦</i><span>Investment</span><i>✦</i>
            <span>Commercial</span><i>✦</i><span>Land &amp; development</span><i>✦</i>
            <span>Relocation</span><i>✦</i><span>Nova Scotia</span><i>✦</i>
          </div>
          ...
          <div className="shell profile-layout">
            <div className="profile-visual reveal">
              <div className="profile-photo-frame">
                <img src="/images/pavneet-studio-portrait.jpg" alt="Pavneet Singh, Nova Scotia REALTOR®" data-parallax="soft" />
            ...
            <div className="profile-content reveal reveal-delay">
              ...
              <div className="language-line">
                <span>English</span><span>Punjabi</span><span>Hindi</span><span>Urdu</span><span>Gujarati</span><span>Spanish</span>
              </div>
